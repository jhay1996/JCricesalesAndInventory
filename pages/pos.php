                    ...
                    <h4 class="m-1 text-lg text-primary">Product category</h4>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs">
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#keyboard" data-toggle="tab">1kg</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#mouse" data-toggle="tab">2kg</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href ="#" data-target="#headset" data-toggle="tab">3kg</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href ="#" data-target="#cpu" data-toggle="tab">4kg</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href ="#" data-target="#monitor" data-toggle="tab">5kg</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href ="#" data-target="#motherboard" data-toggle="tab">10kg</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href ="#" data-target="#processor" data-toggle="tab">25kg</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href ="#" data-target="#powersupply" data-toggle="tab">50kg</a>
                              </li>
                              <li class="nav-item">
